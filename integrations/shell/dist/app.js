...
function syncNoteInjection(noteActive, spanEnd) {
...
`, s);
  ...
  const newRaw = desired === null ? clean : clean.slice(0, desired) + `
...
`;
  ...
  const getText = () => stripInjection(opts.textarea.plainText);
  const getCursor = () => stripCursor(opts.textarea.cursorOffset);
  bootResult = boot({
    hostVersion: "0.1.0",
    ...
    statusSnapshotHook: (payload) => {
      ...
      const undoConf = payload?.undoConfirmation;
      const combined = undoConf ? undoConf : wordPart && agentBadge ? `${wordPart} | ${agentBadge}` : agentBadge ?? wordPart ?? null;
...
var CURSOR_MOVING_KEYS = new Set([
  "up",
  "down",
  "left",
  "right",
...
`, d0);
  ...
  if (nextNoteText !== _termLastNoteText) {
    try {
      _termLog?.("debug", "inlineNote", { cursor, note: nextNoteText, row: noteAnchor?.row, col: noteAnchor?.col });
    } catch {}
    ...
    while ((m = re.exec(row)) !== null) {
      ...
      if (m[3] !== undefined)
        out.push((() => {
          ...
          _$insert(_el$2, () => m[3]);
          _$effect((_$p) => _$setProp(_el$2, "attributes", TextAttributes.DIM, _$p));
          return _el$2;
        })());
      else
        out.push((() => {
...
`);
  ...
  if (props.keepAlive) {
    return (() => {
      var _el$6 = _$createElement("box"), _el$7 = _$createElement("box"), _el$8 = _$createElement("textarea");
        ...
        return () => _c$() && (() => {
          ...
          _$effect((_p$) => {
            var _v$ = {
              ...
              left: note().col,
              zIndex: 10
            }, _v$2 = TextAttributes.DIM;
            _v$ !== _p$.e && (_p$.e = _$setProp(_el$9, "style", _v$, _p$.e));
            _v$2 !== _p$.t && (_p$.t = _$setProp(_el$0, "attributes", _v$2, _p$.t));
            return _p$;
          }, {
            e: undefined,
            t: undefined
  ...
  return (() => {
      ...
      return () => _c$5() && (() => {
        ...
        _$effect((_p$) => {
          var _v$3 = {
            ...
            left: note().col,
            zIndex: 10
          }, _v$4 = TextAttributes.DIM;
          _v$3 !== _p$.e && (_p$.e = _$setProp(_el$24, "style", _v$3, _p$.e));
          _v$4 !== _p$.t && (_p$.t = _$setProp(_el$25, "attributes", _v$4, _p$.t));
          return _p$;
        }, {
          e: undefined,
          t: undefined
    ...
    _$insert(_el$23, (() => {
      ...
      return () => _c$7() ? (() => {
        ...
        var _el$29 = _$createElement("box"), _el$30 = _$createElement("text"), _el$32 = _$createElement("text");
        _$insertNode(_el$29, _el$30);
        _$insertNode(_el$29, _el$32);
        _$setProp(_el$29, "style", {
          flexDirection: "row"
        });
        _$insertNode(_el$30, _$createTextNode(`C_`));
        _$setProp(_el$30, "fg", "#ffffff");
        _$insertNode(_el$32, _$createTextNode(` OpenCues_ \xB7 Submit: Ctrl+Alt+S \xB7 Cancel: Ctrl+Alt+Q`));
        _$setProp(_el$32, "fg", "#ffffff");
        _$effect((_$p) => _$setProp(_el$30, "attributes", TextAttributes.INVERSE, _$p));
        return _el$29;
      })();
    })());
    return _el$20;
