 ...
 * regress.
 */
export function isInternalSender(sender: browser.runtime.MessageSender | undefined): boolean {
  // `sender.id` is the extension ID. For our own content scripts /
  // popup it equals browser.runtime.id; for any externally-connectable
