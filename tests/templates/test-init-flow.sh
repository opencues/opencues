...
[[ -f .opencues/controls.md ]] || fail ".opencues/controls.md missing"
...
pass "init scaffolded 4 files (no opencues.md)"
...
echo "=== opencues new control ==="
"$OPENCUES" new control my-ctl --project >/dev/null 2>&1 || fail "new control failed"
[[ -f .opencues/controls/my-ctl/cue.md ]] || fail "new control did not create cue.md"
pass "new control scaffolds cue.md"
