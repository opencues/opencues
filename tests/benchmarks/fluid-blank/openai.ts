...
export async function chat(
  ...
  // Detect reasoning models — chat-latest is an alias for gpt-5.5 Instant
  // (still a reasoning model under the hood).
  ...
  if (isReasoning) {
    ...
    // pass pipelines. Override via OPENCUES_OPENAI_REASONING to test
