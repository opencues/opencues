...
const CUES_PROVIDER_VALUES: readonly ValueSpec[] = [
  ...
  { id: 'deepseek',  description: 'DeepSeek — cheapest per correct answer, higher latency' },
...
export const MENU_TUNABLES: readonly MenuTunableSpec[] = [
  ...
  },
  {
    scalar: 'vat-rate',
    group: 'Blanks',
    menuTip: 'The VAT / sales-tax rate (%) the tables blank uses for `120 plus vat _`, `ex vat`, `vat on`. A rate written in the command (`120 plus 19% vat _`) wins over this.',
    values: [
      { id: '20',   description: 'Default — UK standard rate' },
      { id: '0',    description: 'No VAT' },
      { id: '5',    description: 'UK reduced / some GCC states' },
      { id: '7',    description: 'Germany reduced / Singapore-ish / Thailand' },
      { id: '10',   description: 'Australia GST / Japan / Korea' },
      { id: '12.5', description: 'A common reduced rate' },
      { id: '15',   description: 'South Africa / New Zealand GST' },
      { id: '19',   description: 'Germany standard' },
      { id: '21',   description: 'Netherlands / Belgium / Spain standard' },
      { id: '23',   description: 'Ireland / Portugal / Poland standard' },
      { id: '25',   description: 'Sweden / Denmark / Norway standard' },
    ],
  },
  {
    scalar: 'reading-wpm',
