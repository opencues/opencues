...
export const HOSTS = ['apple-notes', 'chrome', 'claude-code', 'gemini-cli', 'opencode', 'shell'] as const;
...
export const NATIVE_HOSTS: readonly Host[] = ['apple-notes', 'claude-code', 'gemini-cli', 'opencode', 'shell'];
