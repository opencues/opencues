...
export type ProviderId = 'groq' | 'openrouter' | 'gemini' | 'openai' | 'openai-subscription' | 'anthropic' | 'cerebras' | 'deepseek' | 'claude-code-cli' | 'opencode-zen' | 'ollama';

export const PROVIDER_IDS: readonly ProviderId[] = ['groq', 'openrouter', 'gemini', 'openai', 'openai-subscription', 'anthropic', 'cerebras', 'deepseek', 'claude-code-cli', 'opencode-zen', 'ollama'];
