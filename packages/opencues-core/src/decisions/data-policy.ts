...
export const DATA_POLICY: Readonly<Record<string, DataPolicyEntry>> = {
  ...
  'date-plus': { blank: 'tables', keyword: 'from today', keywords: ['from today'], strip: CALC_Q, floor: 'calc', keepKeyword: true },
  ...
  'percent-off': { blank: 'tables', keyword: '% off', keywords: ['% off', 'percent off', 'off'], strip: CALC_Q, floor: 'calc', keepKeyword: true },
  'percent-of-what': { blank: 'tables', keyword: 'is what percent of', keywords: ['is what percent of', 'is what % of', 'as a percentage of', 'what percent of'], strip: CALC_Q, floor: 'calc', keepKeyword: true },
  ...
  'percent-plus': { blank: 'tables', keyword: 'plus %', keywords: ['plus %', 'minus %'], strip: CALC_Q, floor: 'calc', keepKeyword: true },
  ...
  'per-hour': { blank: 'tables', keyword: 'per hour', keywords: ['per hour', 'hourly', 'an hour'], strip: CALC_Q, floor: 'calc', keepKeyword: true },
  'per-year': { blank: 'tables', keyword: 'per year', keywords: ['per year', 'annually', 'a year', 'annual salary'], strip: CALC_Q, floor: 'calc', keepKeyword: true },
