...
export const DATA_POLICY: Readonly<Record<string, DataPolicyEntry>> = {
  ...
  'nato': { blank: 'tables', keyword: 'nato for', keywords: ['nato for', 'nato alphabet for', 'phonetic alphabet for', 'spell phonetically', 'spell out phonetically', 'nato'], strip: RAW_Q, floor: 'raw' },
  'morse': { blank: 'tables', keyword: 'morse for', keywords: ['morse for', 'morse code for', 'in morse', 'morse'], strip: RAW_Q, floor: 'raw' },
  'greek': { blank: 'tables', keyword: 'greek letter', keywords: ['greek letter', 'greek for', 'greek alphabet', 'in greek'], strip: RAW_Q, floor: 'raw', optional: true },
  'country-code': { blank: 'tables', keyword: 'country code for', keywords: ['country code for', 'iso code for', 'iso country code for', 'country code', 'alpha-2 for', 'alpha-3 for'], strip: RAW_Q, floor: 'raw' },
  'dialling-code': { blank: 'tables', keyword: 'dialling code for', keywords: ['dialling code for', 'dialing code for', 'calling code for', 'phone code for', 'country calling code for', 'international code for'], strip: RAW_Q, floor: 'raw' },
  'driving-side': { blank: 'tables', keyword: 'driving side in', keywords: ['driving side in', 'drive on the left in', 'drive on the right in', 'which side of the road in', 'driving side'], strip: RAW_Q, floor: 'raw' },
  'plug-type': { blank: 'tables', keyword: 'plug type in', keywords: ['plug type in', 'plug types in', 'power plug in', 'socket type in', 'plug type for', 'plug type'], strip: RAW_Q, floor: 'raw' },
  'tld': { blank: 'tables', keyword: 'tld for', keywords: ['tld for', 'domain ending for', 'country domain for', 'cctld for'], strip: RAW_Q, floor: 'raw' },
  'keycode': { blank: 'tables', keyword: 'keycode for', keywords: ['keycode for', 'key code for', 'keycode of', 'javascript keycode', 'keycode'], strip: RAW_Q, floor: 'raw' },
  'cron': { blank: 'tables', keyword: 'cron for', keywords: ['cron for', 'cron expression for', 'crontab for', 'cron'], strip: RAW_Q, floor: 'raw' },
  'exit-code': { blank: 'tables', keyword: 'exit code', keywords: ['exit code', 'exit status', 'what does exit code', 'signal', 'kill signal'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'cup-grams': { blank: 'tables', keyword: 'cups of', keywords: ['cups of', 'cup of', 'cups in grams', 'cup in grams', 'grams in a cup of'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'oven': { blank: 'tables', keyword: 'oven', keywords: ['oven', 'gas mark', 'fan oven', 'in fan', 'oven temperature'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'paper-size': { blank: 'tables', keyword: 'paper size', keywords: ['paper size', 'size of a4', 'a4 in', 'a3 in', 'a5 in', 'letter size', 'dimensions of'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'shoe-size': { blank: 'tables', keyword: 'shoe size', keywords: ['shoe size', 'uk shoe size', 'us shoe size', 'eu shoe size', 'shoe'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'bed-size': { blank: 'tables', keyword: 'bed size', keywords: ['bed size', 'size of a king bed', 'size of a queen bed', 'size of a double bed', 'mattress size', 'king size bed', 'queen size bed', 'double bed', 'single bed'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'zodiac': { blank: 'tables', keyword: 'zodiac for', keywords: ['zodiac for', 'star sign for', 'zodiac sign for', 'horoscope sign for', 'star sign', 'zodiac'], strip: RAW_Q, floor: 'raw' },
  'chinese-zodiac': { blank: 'tables', keyword: 'chinese zodiac for', keywords: ['chinese zodiac for', 'chinese zodiac', 'year of the', 'chinese year for'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
  'dog-years': { blank: 'tables', keyword: 'dog years for', keywords: ['dog years for', 'dog years', 'in dog years', 'cat years for', 'cat years', 'in cat years'], strip: RAW_Q, floor: 'raw', keepKeyword: true },
};
