// Unit-test the singleton holder pattern that the Gemini CLI patch uses
// to bridge the InputPrompt component's TextBuffer ref to the boot()-time
// host bindings.
//
...
describe('Gemini CLI v0.41 holder-backed prompt access', () => {
