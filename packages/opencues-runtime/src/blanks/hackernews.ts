// HackerNewsBlank — fetches the current frontpage story titles via
...
export interface HackerNewsBlankOptions {
...
export class HackerNewsBlank implements Blank {
  ...
  constructor(opts: HackerNewsBlankOptions = {}) {
