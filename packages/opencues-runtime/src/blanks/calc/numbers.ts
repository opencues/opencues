...
export const NUMBERS: readonly Calculator[] = [
  ...
  { id: 'choose', family: 'numbers', keywords: ['choose', 'combinations', 'permutations', 'ncr', 'npr'], arg: 'segment', keywordIsArg: true, phrase: /^\d+\s*(?:c|p)\s*\d+$/i, example: ['5 choose 2', '10 combinations (20 permutations)'], miss: 'need <n> choose <k>',
