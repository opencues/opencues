...
### Fixed — a bare `_` retry on Gmail (and any contenteditable) could be silently swallowed for up to 1.5s (`@opencues/runtime` 0.35.1 → 0.35.2, `@opencues/chrome` 0.2.181 → 0.2.182)
