...
### Added — Apple Notes integration: `_` blanks answered inline in Notes.app on macOS (`@opencues/apple-notes` 0.1.0 new; `@opencues/core` 0.17.0 → 0.18.0; `@opencues/runtime` 0.13.3 → 0.14.0; `opencues` CLI 0.2.40 → 0.2.41)
