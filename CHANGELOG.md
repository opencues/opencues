...
### Removed — dead `fluid-blank-mode` scalar, end to end + spec bump `0.7-alpha → 0.8-alpha` (`@opencues/core` 0.19.0 → 0.20.0, `@opencues/runtime` 0.16.0 → 0.16.1, `opencues` CLI 0.2.44 → 0.2.45, `SPEC_VERSION` 0.7 → 0.8)
