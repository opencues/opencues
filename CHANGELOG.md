...
### Added — session-contradiction cues: catch yourself contradicting a decision you made earlier in a coding session (`@opencues/core` 0.41.0 → 0.42.4, `@opencues/runtime` 0.28.21 → 0.29.0, `opencues` 0.4.2 → 0.5.1, `@opencues/claude-code` 0.2.10 → 0.2.11)
