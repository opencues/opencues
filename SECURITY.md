...
- **Shell script execution** — cue-blanks execute bash scripts via `execFileSync`. Scripts are defined in config files authored by the repo owner, not by end users or external input.
