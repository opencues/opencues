...
│   ├── features/                  # One file per feature concept (46 files: 45 features + README)
...
|---|---|---|---|
| `SPEC.md` (open-standard) | `cues-spec` | 0.6 (draft) | exported as `SPEC_VERSION` from `@opencues/core` |
